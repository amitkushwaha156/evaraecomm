                    ...
                    <div className="col-lg-7 col-md-6">
                      <div className="single-slider-img single-slider-img-1">
                        <img
                          ...
                          src={`./src/theme/assetss/imgs/slider/slider-${currentIndex}.png`}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-1.png"
                  alt=""
                />
            ...
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-2.png"
                  alt=""
                />
            ...
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-3.png"
                  alt=""
                />
            ...
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-4.png"
                  alt=""
                />
            ...
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-5.png"
                  alt=""
                />
            ...
            <div className="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/theme/icons/feature-6.png"
                  alt=""
                />
                      ...
                      <div className="product-img-action-wrap">
                        ...
                        <div className="product-badges product-badges-position product-badges-mrg">
                          {product.badges.map((badge) => (
                            <span className={badge.toLowerCase()} key={badge}>
                              {badge}
                            </span>
                          ))}
                        </div>
                ...
                >
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-3.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-4.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-5.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-6.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-7.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={-1}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-8.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={0}>
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-1.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
                  ...
                  >
                    <figure className=" img-hover-scale overflow-hidden">
                      <a href="shop-grid-right.html" tabIndex={0}>
                        {" "}
                        <img
                          src="./src/theme/assetss/imgs/shop/category-thumb-2.jpg"
                          alt=""
                        />
                      </a>
                    </figure>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-6">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/banner/banner-1.png"
                  alt=""
                />
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/banner/banner-2.png"
                  alt=""
                />
                <div className="banner-text">
                  <span>Sale off</span>
            ...
            <div className="col-lg-4 d-md-none d-lg-flex">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/banner/banner-3.png"
                  alt=""
                />
                <div className="banner-text">
          ...
          <div className="row">
            <div className="col-lg-6 deal-co">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("./src/theme/assetss/imgs/banner/menu-banner-7.jpg")',
                  visibility: "hidden",
                  animationName: "none",
                }}
              >
            ...
            <div className="col-lg-6 deal-co">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("./src/theme/assetss/imgs/banner/menu-banner-8.jpg")',
                  visibility: "hidden",
                  animationName: "none",
                }}
              >
        ...
        <div className="container pt-25 pb-25">
          ...
          <div className="row">
            <div className="col-lg-3 d-none d-lg-flex">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/banner/banner-9.jpg"
                  alt=""
                />
                <div className="banner-text">
                ...
                >
                  <div className="d-md-flex d-block">
                    <div className="post-thumb d-flex mr-15">
                      ...
                      >
                        <img
                          src="./src/theme/assetss/imgs/blog/blog-2.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                ...
                >
                  <div className="d-md-flex d-block">
                    <div className="post-thumb d-flex mr-15">
                      ...
                      >
                        <img
                          src="./src/theme/assetss/imgs/blog/blog-1.jpg"
                          alt=""
                        />
                      </a>
                    </div>
            ...
            <div className="col-lg-6">
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    <img
                      src="./src/theme/assetss/imgs/banner/banner-5.jpg"
                      alt=""
                    />
                    <div className="banner-text">
                ...
                <div className="col-md-6">
                  ...
                  >
                    <img
                      src="./src/theme/assetss/imgs/banner/banner-6.jpg"
                      alt=""
                    />
                    <div className="banner-text">
                      <span>Big Offer</span>
                  ...
                  >
                    <img
                      src="./src/theme/assetss/imgs/banner/banner-7.jpg"
                      alt=""
                    />
                    <div className="banner-text">
                      <span>Smart Offer</span>
          ...
          <div className="row">
            <div className="col-12">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("./src/theme/assetss/imgs/banner/banner-8.jpg")',
                  visibility: "hidden",
                  animationName: "none",
                }}
              >
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
              ...
              >
                <img
                  src="./src/theme/assetss/imgs/banner/banner-10.jpg"
                  alt=""
                />
                <div className="banner-text">
              ...
              >
                ...
                <article className="row align-items-center">
                  <figure className="col-md-4 mb-0">
                    <a href="shop-product-right.html">
                      <img
                        src="./src/theme/assetss/imgs/shop/thumbnail-1.jpg"
                        alt=""
                      />
                    </a>
                  </figure>
                ...
                <article className="row align-items-center">
                  <figure className="col-md-4 mb-0">
                    <a href="shop-product-right.html">
                      <img
                        src="./src/theme/assetss/imgs/shop/thumbnail-2.jpg"
                        alt=""
                      />
                    </a>
                  </figure>
