...
const ShopCart = () => {
 ...
 const handleClrCart=()=>{
  removeDispatch({type: 'Cart_CLEAR'})
  // console.log("skmkdlk")
 }
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                ...
                {CartItem.length===0? <center className="text-canter h4">No Cart Item </center> :
                    ...
                    <tbody>
                      {CartItem.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td className="action" data-title="Remove">
                            <a  className="text-muted" onClick={() => removeFromCart(item.id)}>
                      ...
                      <tr>
                        <td colSpan={6} className="text-end">
                          <a onClick={handleClrCart} className="text-muted">
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="border p-md-4 p-30 border-radius cart-totals">
                      ...
                      <a href="#" className="btn ">
                        {" "}
                        <i className="fi-rs-box-alt mr-10" /> Proceed To
                        CheckOut
                      </a>
                    </div>
                  </div>
