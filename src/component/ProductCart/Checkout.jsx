                ...
                <tbody>
                  <tr>
                    <td className="image product-thumbnail">
                      <img src="/src/theme/assetss/imgs/shop/product-1-1.jpg" alt="#" />
                    </td>
                    <td>
                      <h5>
                  ...
                  <tr>
                    <td className="image product-thumbnail">
                      <img src="/src/theme/assetss/imgs/shop/product-2-1.jpg" alt="#" />
                    </td>
                    <td>
                      <h5>
                        <a href="shop-product-full.html">
                  ...
                  <tr>
                    <td className="image product-thumbnail">
                      <img src="/src/theme/assetss/imgs/shop/product-3-1.jpg" alt="#" />
                    </td>
                    <td>
                      <i className="ti-check-box font-small text-muted mr-10" />
                      <h5>
                        <a href="shop-product-full.html">
                  ...
                  <tr>
                    ...
                    <td colSpan={2} className="product-subtotal">
                      <span className="font-xl text-brand fw-900">$280.00</span>
                    </td>
                  </tr>
                </tbody>
              </table>
