    ...
    <div className="container pt-25">
      <div className="row">
        ...
        <div className="col-lg-6">
          <img src="/src/theme/assetss/imgs/page/about-1.png" alt="" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container">
      <div className="row mb-50 align-items-center">
        <div className="col-md-6">
          ...
          <h2 className="mb-15 wow fadeIn animated">Top team of experts</h2>
        ...
        <div className="row wow fadeIn animated">
          <div className="col-lg-3 col-md-6">
            <div className="blog-card border-radius-10 overflow-hidden text-center">
              <img
                src="/src/theme/assetss/imgs/page/avatar-1.jpg"
                alt=""
          ...
          <div className="col-lg-3 col-md-6">
            <div className="blog-card border-radius-10 overflow-hidden text-center">
              <img
                src="/src/theme/assetss/imgs/page/avatar-2.jpg"
                alt=""
                className="border-radius-10 mb-30 hover-up"
              />
          ...
          <div className="col-lg-3 col-md-6">
            <div className="blog-card border-radius-10 overflow-hidden text-center">
              <img
                src="/src/theme/assetss/imgs/page/avatar-3.jpg"
                alt=""
                className="border-radius-10 mb-30 hover-up"
              />
          ...
          <div className="col-lg-3 col-md-6">
            <div className="blog-card border-radius-10 overflow-hidden text-center">
              <img
                src="/src/theme/assetss/imgs/page/avatar-4.jpg"
                alt=""
                className="border-radius-10 mb-30 hover-up"
              />
      ...
      <div className="row">
        <div className="col-md-4 text-center mb-md-0 mb-4">
          <img
            ...
            src="/src/theme/assetss/imgs/page/company-1.jpg"
            alt=""
          />
          <h4 className="mt-30 mb-15 wow fadeIn animated">New York, USA</h4>
          <p className="text-grey-3 wow fadeIn animated">
        ...
        <div className="col-md-4 text-center mb-md-0 mb-4">
          <img
            className="btn-shadow-brand hover-up border-radius-10 bg-brand-muted wow fadeIn animated"
            src="/src/theme/assetss/imgs/page/company-2.jpg"
            alt=""
          />
          <h4 className="mt-30 mb-15 wow fadeIn animated">Paris, France</h4>
          <p className="text-grey-3 wow fadeIn animated">
            22 Rue des Carmes
            <br /> 75005 Paris
          </p>
        ...
        <div className="col-md-4 text-center">
          <img
            className="btn-shadow-brand hover-up border-radius-10 bg-brand-muted wow fadeIn animated"
            src="/src/theme/assetss/imgs/page/company-3.jpg"
            alt=""
          />
        ...
        <div className="col-md-6 col-lg-4">
          <div className="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
            <div className="hero-card-icon icon-left-2 hover-up ">
              <img
                className="btn-shadow-brand hover-up border-radius-5 bg-brand-muted"
                src="/src/theme/assetss/imgs/page/avatar-5.jpg"
                alt=""
              />
            </div>
            <div className="pl-30">
