      ...
      <div className="row">
        <div className="col-md-4 mb-4 mb-md-0">
          ...
          <a
            ...
            data-cfemail="64070b0a100507102421120516054a070b09"
          >
            [email&nbsp;protected]
          </a>
          <br />
        ...
        <div className="col-md-4 mb-4 mb-md-0">
          ...
          <a
            href="https://wp.alithemes.com/cdn-cgi/l/email-protection"
            className="__cf_email__"
            data-cfemail="4d2e2223392c2e390d083b2c3f2c632e2220"
          >
            [email&nbsp;protected]
          </a>
          <br />
        ...
        <div className="col-md-4">
          ...
          <a
            href="https://wp.alithemes.com/cdn-cgi/l/email-protection"
            className="__cf_email__"
            data-cfemail="f0939f9e84919384b0b586918291de939f9d"
          >
            [email&nbsp;protected]
          </a>
          <br />
          <a className="btn btn-outline btn-sm btn-brand-outline font-weight-bold text-brand bg-white text-hover-white mt-20 border-radius-5 btn-shadow-brand hover-up">
            {" "}
            <i className="fi-rs-marker mr-10" /> View map
          </a>
        </div>
      </div>
    </div>
